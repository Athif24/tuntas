...
final List<AppTheme> allThemes = [
  ...
  AppTheme(
    name: 'Sage Forest',
    isDark: true,
    bgSolid: const Color(0xFF1C2B22),
    accentColor: const Color(0xFF4CAF82),
    successColor: const Color(0xFF4CAF82),
    errorColor: const Color(0xFFE53935),
    overdueColor: const Color(0xFFFF5252),
    textPrimary: Colors.white,
    textSecondary: const Color(0xB3FFFFFF),
    textHint: const Color(0x80FFFFFF),
    cardBg: const Color(0xFF2E4A38),
    cardBorder: const Color(0xFF3A5A45),
    hasStarField: false,
  ),
  ...
  AppTheme(
    name: 'Warm Sand',
    isDark: true,
    bgSolid: const Color(0xFF2C2218),
    accentColor: const Color(0xFFD4956A),
    ...
    textSecondary: const Color(0xB3FFFFFF),
    textHint: const Color(0x80FFFFFF),
    cardBg: const Color(0xFF3E3025),
    cardBorder: const Color(0xFF4E3D30),
    hasStarField: false,
  ),
  ...
  AppTheme(
    name: 'Rose Dust',
    isDark: true,
    bgSolid: const Color(0xFF2A1A1F),
    accentColor: const Color(0xFFC2687A),
    successColor: const Color(0xFF81C784),
    errorColor: const Color(0xFFE53935),
    overdueColor: const Color(0xFFFF5252),
    textPrimary: Colors.white,
    textSecondary: const Color(0xB3FFFFFF),
    textHint: const Color(0x80FFFFFF),
    cardBg: const Color(0xFF3D252D),
    cardBorder: const Color(0xFF4D303A),
    hasStarField: false,
  ),
];